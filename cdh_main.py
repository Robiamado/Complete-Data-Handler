...
def str_mul(first_str, second_str):
    ...
    return return_str
# allows to definde |...| operators where ... is the name of the Infix instance with a lambda as argument
class infix:
...
# numerical/list/string class with alias operator = and assign operator set()     
class aop(): 
